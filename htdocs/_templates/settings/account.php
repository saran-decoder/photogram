                                ...
                                <form class="row g-3">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Username" value="@samlanson">
                                        </div>
                                    </div>
                                    <!-- Email Address -->
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Email Address" value="sam@webestica.com">
                                        </div>
                                    </div>
                                    <!-- Phone number -->
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Phone number" value="(678) 324-1251">
                                        </div>
                                    </div>
                                    <!-- Birthday -->
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control flatpickr" placeholder="Birthday" value="12/12/1990">
                                        </div>
                                    </div>
                                    <!-- Gender -->
                                    <div class="col-sm-6">
                                        <div class="input-group d-flex flex-nowrap">
                                            ...
                                            <select name="Gender" class="setting-form-control w-100 rounded-end no-outline form-select">
                                    ...
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Status" value="Single">
                                        </div>
                                    </div>
                                    <!-- Location -->
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Location" value="TVM">
                                        </div>
                                    </div>
                                    <!-- Link -->
                                    <div class="col-sm-6">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="setting-form-control form-control" placeholder="Link" value="http://example.com/">
                                        </div>
                                    </div>
                                    <!-- Page information -->
                                    <div class="col-12">
                                        <div class="input-group">
                                            ...
                                            <textarea class="setting-form-control form-control" rows="4" placeholder="About"></textarea>
                                        </div>
