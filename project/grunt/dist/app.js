/*Processed by SNA Labs on 18/3/2024 @ 21:5:43*/
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const generateResponse = () => {
        // Display "Typing..." message while waiting for the response. Use this  <div id="typing-spinner" class="spinner-grow text-primary" role="status"></div>
